...
const LessonCard = ({ lesson, setPreview, showModal, setShowModal, }) => {
    return (
        <div className="lesson" style={{ textAlign: 'center', padding: 'inherit' }}>
                    ...
                    <Card bordered={false} style={{ position: 'relative', width: 500, height: 500, marginTop: "100px" }} cover={<img style={{ width: 500, height: 500, objectFit: 'cover', textAlign: 'center'}} alt="example" src={lesson.lessonimage && lesson.lessonimage !== null && (lesson.lessonimage.Location)} />}>
